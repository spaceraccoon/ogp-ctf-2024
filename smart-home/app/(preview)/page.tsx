...
export default function Home() {
  ...
  const suggestedActions = [
    { title: "View", label: "my security camera photo patio.jpg", action: "View my security camera photo patio.jpg" },
    ...
    {
      title: "What is",
      label: "the weather in Singapore?",
      action: "Get the weather in Singapore",
    },
    {
      title: "How much",
    ...
    {
      title: "Fetch",
      label: "API data from data.gov.sg",
      action: "Fetch DataGovSg API /v2/real-time/api/psi",
    },
  ];
